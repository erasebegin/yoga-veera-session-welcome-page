const pageText = {
  ...
  ru: {
    ...
    btn3: 'отзывы',
    quotes: {
      wellbeing: 'Стремясь к благополучию, мы совершили самые безумные действия на этой планете, но благополучие не настало. Если благополучие — это то, к чему вы стремитесь, заглянуть в себя — это единственный выход.',
      meditation: 'Медитация — это возможность начать движение по направлению к измерению, где вы не будете испытывать стресс внутри себя.',
      immunity: 'Стремясь к благополучию, мы совершили самые безумные действия на этой планете, но благополучие не настало. Если благополучие — это то, к чему вы стремитесь, заглянуть в себя — это единственный выход.',
      immunityFoundation: 'Стремясь к благополучию, мы совершили самые безумные действия на этой планете, но благополучие не настало. Если благополучие — это то, к чему вы стремитесь, заглянуть в себя — это единственный выход.',
      meditationFoundation: 'Медитация — это единственный способ избавиться от стресса, напряжения и беспокойства.',
      success: 'Если вы хотите быть успешными, не стремитесь к успеху — стремитесь к раскрытию своих способностей и возможностей; делайте только лучшее, на что вы способны.',
    ...
    errSub: "Если что-то кажется неправильным, пожалуйста, напишите нам по адресу:"
  },
  es: {
    h1: 'Webinar en vivo',
    h2: function (title) {
